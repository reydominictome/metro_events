...
var update = document.getElementById("Group_124");
var edit = document.getElementById("trash_info");
var cancelupdate = document.getElementsByClassName("Group_125")[0];

edit.onclick = function() {
   update.style.top="173px";
}

cancelupdate.onclick = function() {
   update.style.top="-1500px";
}
